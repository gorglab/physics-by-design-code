...
│   ├── porosity_tpms.py        TPMS porosity sweep + STL family (Figure 5)
│   ├── schonhardt_particles.py Schönhardt twist sweep + STL family (Figure 2, Table 1)
│   ├── inertia_shell.py        Hollow-sphere shell-thickness sweep (Figure 4)
│   ├── strut_lattices.py       Iso-porous and porosity-swept strut lattices (Figures 7, 8, Table 2)
│   ├── heat_transfer_demo.py   1-D transient fin model (Figure 9)
...
├── figures/                    Generated figures from the scripts
```
...
python3 scripts/heat_transfer_demo.py
